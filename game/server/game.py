...
from level.server.level import Level
...
class ServerGame:
    ...
    def create_player(self):
        ...
        self.players.append(player.Player(None, player.PlayerColors.red))

        return player_id

    def create_level(self):
        """Create the level object."""
        self.level = Level(self.surface, self.hud, None, self.lucky_animation_index, self.world, self.lv)
    ...
    def send_back_all_data(self, conn: socket.socket) -> None:
